...
<template>
  <form class="search" @submit.prevent="emit('submit')">
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" style="stroke: var(--muted)" stroke-width="2" stroke-linecap="round"><circle cx="11" cy="11" r="7"></circle><line x1="16.5" y1="16.5" x2="21" y2="21"></line></svg>
...
<style scoped>
.search { max-width: 660px; margin: 0 auto; display: flex; align-items: center; gap: 12px; background: var(--card); border: 1px solid var(--line-strong); border-radius: 999px; padding: 14px 22px; box-shadow: 0 2px 10px var(--shadow); }
